    ...
    def _generate(self,
        ...
        try:
            ...
            for audio_frame in audios:
                ...
                audio_frame_list.append(np.array(resampled_audio_frame))
...
if __name__ == "__main__":
    config = CloseMouthWorkerConfig(
        ...
        resnet_state_dict_file='/mnt/users/chenmuyin/closedmouth_2.0/data_enhancement/checkpoints/resnet18-5c106cde.pth'
    )

    worker = CloseMouthWorker(config)

    video_folder = "/mnt/users/chenmuyin/closedmouth_2.0/testdata/black_frame/black_frame2"
    ...
    for name in names:
        ...
        result = worker.extend_silence_video(video_path, name)
